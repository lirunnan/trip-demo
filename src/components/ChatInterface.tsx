  ...
  const renderTransportation = (transportation: InterCityTransportation) => {
    ...
    const communityGuides = [
      ...
      },
      {
        ...
        destination: '重庆',
        duration: '5天4夜',
        thumbnail: '/images/chongqing.png',
        tags: ['山城', '美食'],
        views: 16890,
        likes: 988,
        rating: 4.8
      ...
      },
      {
        id: 'xizang-7days',
        title: '西藏七日深度游',
        destination: '拉萨·林芝·日喀则',
        duration: '7天6夜',
        thumbnail: '/images/xizang.png',
        tags: ['深度', '高原'],
        views: 17680,
        likes: 1045,
        rating: 4.8
